...
<template>
    ...
    <div class="h-5 z-10 flex">
      <div class="w-50">
        <button @click="goBackInTime()" v-if="records.length > sliceEnd - sliceStart && sliceEnd <= records.length" class="btn w-50 bg-gray-50 border-gray-100 h-7 text-gray-300">
      ...
      <div class="w-50">
        <button @click="goForwardInTime()" v-if="records.length > sliceEnd - sliceStart && sliceStart !== 0" class="btn w-50 bg-gray-50 border-gray-100 h-7 text-gray-300">
